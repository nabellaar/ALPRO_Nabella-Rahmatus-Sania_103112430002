...
func main() {
	fmt.Println("==== Menu Restoran Cepat Saji ====") // menampilkan daftar menu restoran
	...
	var kode int
	fmt.Print("Masukkan kode item (1-5): ") // input kode item oleh pengguna 
	fmt.Scanln(&kode)

	switch kode { // menentukan item dengan kode menggunakan Switch Case
	case 1:
